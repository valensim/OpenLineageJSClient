...
export class HttpConfig {
	 ...
	 */
	constructor(url: string, options: AxiosRequestConfig = {}, token: string | null = null) {
...
export class HttpTransport implements Transport {
	...
	static fromFile(config:TransportConfig): HttpTransport {
		...
		return new HttpTransport(new HttpConfig(config.url, config.options || {}, config.token || null));
	}
}